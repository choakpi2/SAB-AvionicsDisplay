...
class globaltime_c(object):  # Provide a global timer for timing features
...
class texture_image(object):
    ...
    def draw(self, x, y):
        ...
        glVertex3f(self.w, 0, 0.0)  # Bottom Right Of The Texture and Quad
        glTexCoord2f(1.0, 1.0)
        glVertex3f(self.w, self.h,  0.0)  # Top Right Of The Texture and Quad
        glTexCoord2f(0.0, 1.0)
        glVertex3f(0, self.h, 0.0)  # Top Left Of The Texture and Quad
        glEnd()
        glDisable(GL_TEXTURE_2D)
        glPopMatrix()
